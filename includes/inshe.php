<main id="inshe" class="submenu-main">
                ...
                <div class="col-md-12">
                    <div class="block-1-content">
                        ...
                        <div class="col-md-6 block-1-text">
                            <?php echo $lang['other-block-text-1']?>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="submenu-banner" style="background-image: url(../img/tvarinnictvo/cows.png);">
        <p><?php echo $lang['other-submenu-banner']?></p>
    </section>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="block-1-content flex-row-reverse">
                        ...
                        <div class="col-md-6 block-1-text">
                            <?php echo $lang['other-block-text-2']?>
                        </div>
                    </div>
                </div>
            </div>
