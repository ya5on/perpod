<main id="metaloplastykovikonstrukcii" class="submenu-main">
    <div class="submenu" style="background-image: url(../img/metaloplastykovikonstrukcii/metal-bg.png);background-size: cover;">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="metal-h1"><?php echo $lang['metaloplastykovikonstrukcii']?></h1>
                </div>
                <div class="col-md-12">
                    <h4><?php echo $lang['metal-h4']?></h4>
                </div>
            </div>
            <div class="col-md-12 ">
                ...
                <div class="col-md-12">
                    <div class="block-1-content">
                        <div class="col-md-6 block-1-img">
                            <img src="img/metaloplastykovikonstrukcii/okna.png" alt="">
                        </div>
                        <div class="col-md-6 block-1-text">
                            <?php echo $lang['metal-block-text-1']?>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="submenu-banner" style="background-image: url(../img/metaloplastykovikonstrukcii/banner.png);">
        <p><?php echo $lang['metal-submenu-banner']?></p>
    </section>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="block-1-content flex-row-reverse">
                        ...
                        <div class="col-md-6 block-1-text">
                            <?php echo $lang['metal-block-text-2']?>
                        </div>
                    </div>
                </div>
            </div>
