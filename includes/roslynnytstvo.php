<main id="roslynnytstvo" class="submenu-main">
    <div class="submenu" style="background-image: url(../img/roslynnytstvo/roslny-bg.png); background-size: cover;">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1><?php echo $lang['roslynnytstvo']?></h1>
                </div>
                <div class="col-md-12">
                    <h4><?php echo $lang['roslynnytstvo-h4']?></h4>
                </div>
            </div>
            <div class="col-md-12 ">
                ...
                <div class="col-md-12">
                    <div class="block-1-content">
                        ...
                        <div class="col-md-6 block-1-text">
                            <p>
                            <?php echo $lang['roslyn-block-1-text']?></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="submenu-banner" style="background-image: url(../img/roslynnytstvo/cars.png);">
        <p><?php echo $lang['roslyn-submenu-banner']?></p>
    </section>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="block-1-content flex-row-reverse">
                        ...
                        <div class="col-md-6 block-1-text">
                            <?php echo $lang['roslyn-block-2-text']?>
                        </div>
                    </div>
                </div>
            </div>
